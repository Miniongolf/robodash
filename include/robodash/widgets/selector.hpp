...
/**
 * A function selector for selecting autonomous routines.
 *
 * If available, automatically saves the current configuration to an SD card and loads it on the
 * next run. Also supports displaying images from the SD card.
 *
